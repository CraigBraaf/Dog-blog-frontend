  ...
  <div class="wrapper">
    ...
    <form @submit.prevent="handleSubmit" action="POST">
      <div class="form-group">
        ...
        <input type="text" name="Name" id="name" placeholder="First and Last" required minlength="3" maxlength="25" v-model="name" />
      </div>
      <div class="form-group">
        <label for="email">Email Address</label>
        <input type="email" name="Email" id="email" placeholder="email@gmail.com" required v-model="email" />
      </div>
      <div class="form-group">
        <label for="message">Message</label>
        <textarea name="Message" id="message" rows="5" placeholder="Type your message here...." v-model="message"></textarea>
      </div>
      <div class="form-group">
